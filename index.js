...
const initializeBot = async () => {
    ...
    console.log(chalk.green('LËGĚNDÃRY BØT'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('LËGĒNDÃRY BØT sᴏʟᴏs ᴀʟʟ....\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./server');
            telegramLoaded = true;                              
            console.log(chalk.green('✅ LËGĒNDÃRY BØT ɪs sᴜᴄᴄᴇssғᴜʟʟʏ ᴀᴄᴛɪᴠᴇ'));
        } catch (error) {
    ...
    console.log(telegramLoaded ? chalk.green( 'LËGĒNDÃRY BØT: ᴀᴄᴛɪᴠᴇ ✅') : chalk.red('❌ LËGĒNDÃRY ŁAB  2025'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ LËGĒNDÃRY BØT  ᴀᴄᴛɪᴠᴇ!\n'));
    }
